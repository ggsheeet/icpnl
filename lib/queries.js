...
export const GET_C_FIR = gql`
  query C_FIR {
    mediaItem(id: "347", idType: DATABASE_ID) {
      altText
      caption
      mediaDetails {
        width
...
export const GET_C_SEC = gql`
  query C_SEC {
    mediaItem(id: "638", idType: DATABASE_ID) {
      altText
      caption
      mediaDetails {
        width
...
export const GET_C_THI = gql`
  query C_THI {
    mediaItem(id: "345", idType: DATABASE_ID) {
      altText
      caption
      mediaDetails {
        width
...
export const GET_C_FOU = gql`
  query C_FOU {
    mediaItem(id: "425", idType: DATABASE_ID) {
      altText
      caption
      mediaDetails {
        width
...
export const GET_C_FIV = gql`
  query C_FIV {
    mediaItem(id: "426", idType: DATABASE_ID) {
      altText
      caption
      mediaDetails {
        width
...
export const GET_C_SIX = gql`
  query C_SIX {
    mediaItem(id: "427", idType: DATABASE_ID) {
      altText
      caption
      mediaDetails {
        width
...
export const GET_C_SEV = gql`
  query C_SEV {
    mediaItem(id: "503", idType: DATABASE_ID) {
      altText
      caption
      mediaDetails {
        width
...
export const GET_C_EIG = gql`
  query C_EIG {
    mediaItem(id: "505", idType: DATABASE_ID) {
      altText
      caption
      mediaDetails {
        width
...
export const GET_C_NIN = gql`
  query C_EIG {
    mediaItem(id: "504", idType: DATABASE_ID) {
      altText
      caption
      mediaDetails {
        width
