...
export const GET_POSTS_FIR = gql`
  query GetPostsFIR {
    posts(first: 1, where: { categoryName: "fiscal", status: PUBLISH }) {
      nodes {
        id
        title
        content
...
export const GET_LOC = gql`
  query LOC {
    mediaItem(id: "118", idType: DATABASE_ID) {
      altText
      caption
      mediaDetails {
        width
...
export const GET_MAG = gql`
  query MAG {
    mediaItem(id: "117", idType: DATABASE_ID) {
      altText
      caption
      mediaDetails {
        width
...
export const GET_ACC = gql`
  query ACC {
    mediaItem(id: "116", idType: DATABASE_ID) {
      altText
      caption
      mediaDetails {
        width
...
export const GET_C_FIR = gql`
  query C_FIR {
    mediaItem(id: "1045", idType: DATABASE_ID) {
      altText
      caption
      mediaDetails {
        width
...
export const GET_C_SEC = gql`
  query C_SEC {
    mediaItem(id: "1046", idType: DATABASE_ID) {
      altText
      caption
      mediaDetails {
        width
...
export const GET_C_THI = gql`
  query C_THI {
    mediaItem(id: "1161", idType: DATABASE_ID) {
      altText
      caption
      mediaDetails {
        width
...
export const GET_C_FOU = gql`
  query C_FOU {
    mediaItem(id: "1163", idType: DATABASE_ID) {
      altText
      caption
      mediaDetails {
        width
...
export const GET_C_FIV = gql`
  query C_FIV {
    mediaItem(id: "1294", idType: DATABASE_ID) {
      altText
      caption
      mediaDetails {
        width
...
export const GET_C_SIX = gql`
  query C_SIX {
    mediaItem(id: "1162", idType: DATABASE_ID) {
      altText
      caption
      mediaDetails {
        width
...
export const GET_C_SEV = gql`
  query C_SEV {
    mediaItem(id: "1233", idType: DATABASE_ID) {
      altText
      caption
      mediaDetails {
        width
...
export const GET_C_EIG = gql`
  query C_EIG {
    mediaItem(id: "1230", idType: DATABASE_ID) {
      altText
      caption
      mediaDetails {
        width
...
export const GET_C_NIN = gql`
  query C_EIG {
    mediaItem(id: "1232", idType: DATABASE_ID) {
      altText
      caption
      mediaDetails {
        width
...
export const GET_PRESS = gql`
  query PRESS {
    mediaItem(id: "125", idType: DATABASE_ID) {
      altText
      caption
      mediaDetails {
        width
...
export const GET_SAT = gql`
  query SAT {
    mediaItem(id: "126", idType: DATABASE_ID) {
      altText
      caption
      mediaDetails {
        width
...
export const GET_POD = gql`
  query POD {
    mediaItem(id: "127", idType: DATABASE_ID) {
      altText
      mediaDetails {
        width
        height
