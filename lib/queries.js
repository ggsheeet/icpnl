...
export const GET_C_FIR = gql`
  query C_FIR {
    mediaItem(id: "1981", idType: DATABASE_ID) {
      altText
      caption
      mediaDetails {
        width
...
export const GET_C_SEC = gql`
  query C_SEC {
    mediaItem(id: "2696", idType: DATABASE_ID) {
      altText
      caption
      mediaDetails {
        width
...
export const GET_C_THI = gql`
  query C_THI {
    mediaItem(id: "2694", idType: DATABASE_ID) {
      altText
      caption
      mediaDetails {
        width
...
export const GET_C_FOU = gql`
  query C_FOU {
    mediaItem(id: "2695", idType: DATABASE_ID) {
      altText
      caption
      mediaDetails {
        width
...
export const GET_C_FIV = gql`
  query C_FIV {
    mediaItem(id: "2866", idType: DATABASE_ID) {
      altText
      caption
      mediaDetails {
        width
...
export const GET_C_SIX = gql`
  query C_SIX {
    mediaItem(id: "2868", idType: DATABASE_ID) {
      altText
      caption
      mediaDetails {
        width
...
export const GET_C_SEV = gql`
  query C_SEV {
    mediaItem(id: "2867", idType: DATABASE_ID) {
      altText
      caption
      mediaDetails {
        width
...
export const GET_C_EIG = gql`
  query C_EIG {
    mediaItem(id: "1511", idType: DATABASE_ID) {
      altText
      caption
      mediaDetails {
        width
...
export const GET_C_NIN = gql`
  query C_EIG {
    mediaItem(id: "1512", idType: DATABASE_ID) {
      altText
      caption
      mediaDetails {
        width
