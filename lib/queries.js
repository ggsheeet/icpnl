...
export const GET_LOC = gql`
  query LOC {
    mediaItem(id: "3821", idType: DATABASE_ID) {
      altText
      caption
      mediaDetails {
        width
...
export const GET_C_FIR = gql`
  query C_FIR {
    mediaItem(id: "3455", idType: DATABASE_ID) {
      altText
      caption
      mediaDetails {
        width
...
export const GET_C_SEC = gql`
  query C_SEC {
    mediaItem(id: "3456", idType: DATABASE_ID) {
      altText
      caption
      mediaDetails {
        width
...
export const GET_C_THI = gql`
  query C_THI {
    mediaItem(id: "3457", idType: DATABASE_ID) {
      altText
      caption
      mediaDetails {
        width
...
export const GET_C_FOU = gql`
  query C_FOU {
    mediaItem(id: "3458", idType: DATABASE_ID) {
      altText
      caption
      mediaDetails {
        width
...
export const GET_C_FIV = gql`
  query C_FIV {
    mediaItem(id: "3937", idType: DATABASE_ID) {
      altText
      caption
      mediaDetails {
        width
...
export const GET_C_SIX = gql`
  query C_SIX {
    mediaItem(id: "3938", idType: DATABASE_ID) {
      altText
      caption
      mediaDetails {
        width
...
export const GET_C_SEV = gql`
  query C_SEV {
    mediaItem(id: "3934", idType: DATABASE_ID) {
      altText
      caption
      mediaDetails {
        width
...
export const GET_C_EIG = gql`
  query C_EIG {
    mediaItem(id: "3936", idType: DATABASE_ID) {
      altText
      caption
      mediaDetails {
        width
...
export const GET_C_NIN = gql`
  query C_EIG {
    mediaItem(id: "3935", idType: DATABASE_ID) {
      altText
      caption
      mediaDetails {
        width
