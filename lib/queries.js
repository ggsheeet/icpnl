...
export const GET_C_FIR = gql`
  query C_FIR {
    mediaItem(id: "199", idType: DATABASE_ID) {
      altText
      caption
      mediaDetails {
        width
...
export const GET_C_SEC = gql`
  query C_SEC {
    mediaItem(id: "200", idType: DATABASE_ID) {
      altText
      caption
      mediaDetails {
        width
...
export const GET_C_THI = gql`
  query C_THI {
    mediaItem(id: "201", idType: DATABASE_ID) {
      altText
      caption
      mediaDetails {
        width
...
export const GET_C_FOU = gql`
  query C_FOU {
    mediaItem(id: "124", idType: DATABASE_ID) {
      altText
      caption
      mediaDetails {
        width
...
export const GET_C_SIX = gql`
  query C_SIX {
    mediaItem(id: "122", idType: DATABASE_ID) {
      altText
      caption
      mediaDetails {
        width
