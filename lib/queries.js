...
export const GET_C_FIR = gql`
  query C_FIR {
    mediaItem(id: "10", idType: DATABASE_ID) {
      altText
      caption
      mediaDetails {
        width
...
export const GET_C_SEC = gql`
  query C_SEC {
    mediaItem(id: "11", idType: DATABASE_ID) {
      altText
      caption
      mediaDetails {
        width
...
export const GET_C_THI = gql`
  query C_THI {
    mediaItem(id: "25", idType: DATABASE_ID) {
      altText
      caption
      mediaDetails {
        width
...
export const GET_C_FOU = gql`
  query C_FOU {
    mediaItem(id: "12", idType: DATABASE_ID) {
      altText
      caption
      mediaDetails {
        width
...
export const GET_C_SIX = gql`
  query C_SIX {
    mediaItem(id: "26", idType: DATABASE_ID) {
      altText
      caption
      mediaDetails {
        width
...
export const GET_C_SEV = gql`
  query C_SEV {
    mediaItem(id: "28", idType: DATABASE_ID) {
      altText
      caption
      mediaDetails {
        width
...
export const GET_C_EIG = gql`
  query C_EIG {
    mediaItem(id: "29", idType: DATABASE_ID) {
      altText
      caption
      mediaDetails {
        width
