...
export const GET_POSTS_FIS = gql`
  query GetPostsFIS {
    posts(last: 15, where: { categoryName: "fiscal", status: PUBLISH }) {
      nodes {
        id
        title
        content
...
export const GET_C_THI = gql`
  query C_THI {
    mediaItem(id: "1982", idType: DATABASE_ID) {
      altText
      caption
      mediaDetails {
        width
...
export const GET_C_FOU = gql`
  query C_FOU {
    mediaItem(id: "2061", idType: DATABASE_ID) {
      altText
      caption
      mediaDetails {
        width
...
export const GET_C_FIV = gql`
  query C_FIV {
    mediaItem(id: "2520", idType: DATABASE_ID) {
      altText
      caption
      mediaDetails {
        width
...
export const GET_C_SEV = gql`
  query C_SEV {
    mediaItem(id: "2521", idType: DATABASE_ID) {
      altText
      caption
      mediaDetails {
        width
