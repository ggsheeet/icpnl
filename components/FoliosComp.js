...
const FoliosComp = () => {
	return (
		<div className='flex flex-col items-center justify-center w-full font-bold pt-[4vh] text-sm md:text-base'>
			<p className='w-[88vw] md:w-[82vw] lg:w-[62vw] max-w-[1280px] bg-brand-icpnl-red text-center text-brand-white-smoke mb-[2vh]'>
				FOLIOS IMCP
			</p>
			<table className='w-[88vw] md:w-[82vw] lg:w-[62vw] max-w-[1280px] text-xs md:text-sm'>
				<tbody>
					<tr>
						<td>
			...
			<a
				href='https://imcp.org.mx/servicios/folios/'
				rel='noopener noreferrer'
				target='_blank'
				className='text-center text-[#333] mt-[2vh] underline underline-offset-4'
			>
				Ver más Folios IMCP
			</a>
		</div>
