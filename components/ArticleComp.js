      ...
      <div key={article.id} className="w-full">
        <div className="relative">
          <img
            ...
            alt={article.title}
            className="not-selectable w-full h-[63vw] md:h-[40vw] lg:h-[35vw] xl:h-[33vw] object-cover"
          />
        ...
        <div className="text-start w-full px-[2%] relative">
          ...
          <div
            ...
            className="text-brand-link font-medium text-[1.7vh] md:text-[1.75vh] lg:text-[2.7vw] xl:text-[2.7vh] py-[0.1%] mt-[2%] md:mt-[0.5%] mb-[3%] md:mb-[1%] rounded-[2vw] underline"
          />
        </div>
      </div>
    </div>
