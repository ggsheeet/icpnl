...
const CoursesComp = () => {
	...
	const mediaItems = [mediaTHI, mediaFOU, mediaFIV, mediaSIX, mediaSEV, mediaEIG]

	//  mediaFIR, mediaSEC, , mediaNIN
	...
	return (
		<>
		{/* loadingFIR | loadingSEC |  | loadingNIN */}
			{ loadingTHI | loadingFOU | loadingFIV | loadingSIX | loadingSEV | loadingEIG ? (
