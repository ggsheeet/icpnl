...
const CoursesComp = () => {
	...
	const mediaItems = [mediaTHI, mediaFOU, mediaFIV, mediaSIX, mediaSEV, mediaEIG, mediaNIN]
	...
	return (
		<>
		{/* loadingFIR | loadingSEC |  */}
			{ loadingTHI | loadingFOU | loadingFIV | loadingSIX | loadingSEV | loadingEIG | loadingNIN ? (
