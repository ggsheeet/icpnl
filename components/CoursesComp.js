...
const CoursesComp = () => {
	...
	const mediaItems = [mediaFIV, mediaSIX, mediaSEV, mediaEIG, mediaNIN]

	//  mediaFIR, mediaSEC, mediaTHI, mediaFOU, 
	...
	return (
		<>
		{/* loadingFIR | loadingSEC | loadingTHI | loadingFOU |  */}
			{ loadingFIV | loadingSIX | loadingSEV | loadingEIG | loadingNIN ? (
