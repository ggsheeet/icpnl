...
const CoursesComp = () => {
	...
	const mediaItems = [mediaFIV, mediaSIX, mediaSEV, mediaEIG]

	// mediaFIR, mediaSEC, mediaTHI, mediaFOU, mediaNIN
	...
	return (
		<>
		{/* loadingFIR | loadingSEC | loadingTHI | loadingFOU | loadingNIN */}
			{ loadingFIV | loadingSIX | loadingSEV | loadingEIG ? (
