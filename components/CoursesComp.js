...
const CoursesComp = () => {
	...
	const mediaItems = [mediaSEC, mediaTHI, mediaFOU, mediaFIV, mediaSIX, mediaSEV]

	//  mediaFIR, , mediaEIG, mediaNIN
	...
	return (
		<>
		{/* loadingFIR |  | loadingEIG | loadingNIN */}
			{ loadingSEC | loadingTHI | loadingFOU | loadingFIV | loadingSIX | loadingSEV ? (
